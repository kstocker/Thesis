...
Once I computed the gaussian weight for each datapoint in the $X_{n}$ matrix, I ran a weighted linear regression on each of the $T$ rows of the $X_{n}$ matrix, using the gaussian weights from the previously computed weight matrix. 
