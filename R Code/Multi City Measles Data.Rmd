...
min(indianapolis_initials[[1]]$mse)
...
ny_initials <- list(initials=ny_initials, indices = which(ny_initials$mse == min(ny_initials$mse), arr.ind=TRUE), chosen_props = c(i_prop=ny_initials$i_prop[which(ny_initials$mse == min(ny_initials$mse), arr.ind=TRUE)[1]], s_prop=ny_initials$s_prop[which(ny_initials$mse == min(ny_initials$mse), arr.ind=TRUE)[2]]))
...
save(chicago_initials, file="chicago_initials")
```
