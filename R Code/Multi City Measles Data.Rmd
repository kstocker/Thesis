...
#New Orleans
neworleans <- read_in_city("NEW ORLEANS")[[1]]
...
boston_bayes <- run_bayes(boston, which_stan="high_pop") #broken

phil_bayes <- run_bayes(phil, which_stan = "high_pop")  #broken

stlouis_bayes <- run_bayes(stlouis, which_stan="high_pop") #broken

baltimore_bayes <- run_bayes(baltimore, which_stan="high_pop") #broken

detroit_bayes <- run_bayes(detroit, which_stan="high_pop") #broken

cleveland_bayes <- run_bayes(cleveland, which_stan = "high_pop") #broken
```
...
#Chicago: Betas follow same trend as paper, but they are consistently below the paper values
