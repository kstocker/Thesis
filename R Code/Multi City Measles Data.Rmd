...
load("~/Documents/Github/Thesis Git/R Code/Chicago_Bayes")
load("~/Documents/Github/Thesis Git/R Code/NY_Bayes")
load("~/Documents/Github/Thesis Git/R Code/Baltimore_Bayes")
load("~/Documents/Github/Thesis Git/R Code/Boston_Bayes")
```
...
ny_betas_est <- accuracy_check(ny_betas, ny_bayes)$beta_estimate
ny_sbar_range <- accuracy_check(ny_betas, ny_bayes)$sbar_estimate

save(baltimore_bayes, file="Baltimore_Bayes")
save(boston_bayes, file="Boston_Bayes")
...
choose_sinit <- function(city, betas, bayes){
  beta_est <- accuracy_check(betas, bayes)$beta_estimate
  
  s_prop <- seq(0.025, 0.05, 0.0001)#check with this interval, then bump it to   
                                    #0.00001 
...
which(ny_mse_matrix$mse == min(ny_mse_matrix$mse), arr.ind = TRUE)
