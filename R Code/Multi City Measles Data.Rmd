...
scale_optim_chicago <- 0.89 

chicago <- local_regression(chicago, scale_optim_chicago)
...
baltimore <- local_regression(baltimore, scale_optim_baltimore)
...
#phil_bayes <- run_bayes(phil, which_stan = "low_pop")
...
- what is the best way to deal with NA's? I don't want to delete them because it will shift my biweeks, and there is no "na.rm" or other option in the cumsum function, which is necessary to reconstruction 
