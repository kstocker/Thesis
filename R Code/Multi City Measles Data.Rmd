...
indianapolis_initials <- list(initials=indianapolis_initials, indices = which(indianapolis_initials$mse == min(indianapolis_initials$mse), arr.ind=TRUE), chosen_props = c(i_prop=indianapolis_initials$i_prop[which(indianapolis_initials$mse == min(indianapolis_initials$mse), arr.ind=TRUE)[1]], s_prop=indianapolis_initials$s_prop[which(indianapolis_initials$mse == min(indianapolis_initials$mse), arr.ind=TRUE)[2]]))
...
chicago_1000_sims <- apply(chicago_betasample, MARGIN=1, function(x) 
                           Sim(beta=rep_len(x, length.out = 546), city=chicago, 
                               s_prop=chicago_initials$s_prop[38], 
                               chicago_initials$i_prop[43], plot=FALSE))
