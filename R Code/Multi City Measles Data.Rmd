...
boston <- read_in_city("BOSTON")[[1]]
boston_betas <- read_in_city("BOSTON")[[2]]

#scale_optim_boston <- optim_bandwidth(boston) 
scale_optim_boston <- 0.7 #from previous analysis 

boston <- local_regression(boston, scale_optim_ny)


#New York Reconstruction (12.52898 mins run time)
newyork <- read_in_city("NEW YORK")[[1]]
ny_betas <- read_in_city("NEW YORK")[[2]]
...
#Philadelphia
phil <- read_in_city("PHILADELPHIA")[[1]]
phil_betas <- read_in_city("PHILADELPHIA")[[2]]
...
#St Louis
stlouis <- read_in_city("ST LOUIS")[[1]]
stlouis_betas <- read_in_city("ST LOUIS")[[2]]
...
#Baltimore
baltimore <- read_in_city("BALTIMORE")[[1]]
baltimore_betas <- read_in_city("BALTIMORE")[[2]]
...
#Detroit
detroit <- read_in_city("DETROIT")[[1]]

#Cleveland
cleveland <- read_in_city("CLEVELAND")[[1]]

#Indianapolis
Indianapolis <- read_in_city("INDIANAPOLIS")[[1]]
...
#Los Angeles
LA <- read_in_city("LOS ANGELES")[[1]]

#Washington
washington <- read_in_city("WASHINGTON")[[1]]

#Spokane
spokane <- read_in_city("SPOKANE")[[1]]
