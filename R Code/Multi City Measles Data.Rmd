...
indianapolis_initials <- choose_initials(indianapolis, indianapolis_betas, 
                                         indianapolis_bayes)
which(indianapolis_initials$mse == min(indianapolis_initials$mse), 
      arr.ind=TRUE)#r=77, col=98
indianapolis_initials$i_prop[77]#0.00076
indianapolis_initials$s_prop[98]#0.04925
Sim(beta=rep_len(indianapolis_accuracy$beta_estimate, length.out = 546), 
    city=indianapolis, s_prop = indianapolis_initials$s_prop[98], i_prop = 
    indianapolis_initials$i_prop[77], plot=TRUE)[[2]]

#Spokane
paste("Spokane Model")
spokane_initials <- validate_model(city=spokane, betas=spokane_betas, bayes=spokane_bayes, accuracy = spokane_accuracy)
...
neworleans_initials <- choose_initials(neworleans, neworleans_betas, 
                                       neworleans_bayes)
which(neworleans_initials$mse == min(neworleans_initials$mse), arr.ind=TRUE)
neworleans_initials$i_prop[]
neworleans_initials$s_prop[]
Sim(beta=rep_len(neworleans_accuracy$beta_estimate, length.out = 546), city= 
      neworleans, s_prop = neworleans_initials$s_prop[], i_prop = 
      neworleans_initials$i_prop[], plot=TRUE)[[2]]


save(indianapolis_initials, file="indianapolis_initials")
save(spokane_initials, file="spokane_initials")
save(neworleans_initials, file="neworleans_initials")
```
...
paste("Spokane Model")
spokane_initials <- choose_initials(spokane, spokane_betas, spokane_bayes)
which(spokane_initials$mse == min(spokane_initials$mse), arr.ind=TRUE)
spokane_initials$i_prop[]
spokane_initials$s_prop[]
Sim(beta=rep_len(spokane_accuracy$beta_estimate, length.out=546), city=spokane, 
    s_prop = spokane_initials$s_prop[], i_prop = spokane_initials$i_prop[], 
    plot=TRUE)[[2]]
```
