...
Sim(beta=rep_len(chicago_accuracy$beta_estimate, length.out = 546), city=chicago, 
               ...
               plot=TRUE)[[2]]
paste("Chicago Simulation MSE")
min(chicago_initials$mse)
...
paste("Indianapolis Simulation MSE")
min(indianapolis_initials$mse)


#Spokane
paste("Spokane Model")
#spokane_initials <- validate_model(city=spokane, betas=spokane_betas, 
#                                   bayes=spokane_bayes, accuracy = 
#                                   spokane_accuracy)

load("/Users/Kaitlyn/Documents/Github/Thesis Git/R Code/spokane_initials")
props <- spokane_initials[[3]]
Sim(beta=rep_len(spokane_accuracy$beta_estimate, length.out=546), city=spokane, 
    s_prop = props[2], i_prop = props[1], 
    plot=TRUE)[[2]]
paste("Spokane Model MSE")
min(spokane_initials[[1]]$mse)

#New Orleans 
paste("New Orleans Model")
#neworleans_initials <- validate_model(city=neworleans, betas=neworleans_betas, 
                                      # bayes=neworleans_bayes, accuracy = 
                                      # neworleans_accuracy)
load("/Users/Kaitlyn/Documents/Github/Thesis Git/R Code/neworleans_initials")

props <- neworleans_initials[[3]]

Sim(beta=rep_len(neworleans_accuracy$beta_estimate, length.out=546), 
    city=neworleans, s_prop = props[2], i_prop = props[1],  plot=TRUE)[[2]]
paste("New Orleans Model MSE")
min(neworleans_initials[[1]]$mse)
