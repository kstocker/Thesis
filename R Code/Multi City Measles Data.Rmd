...
ny_mse <- forward_sim(newyork, ny_betas, ny_bayes)

plot(ny_mse[[1]])
which.min(ny_mse[[1]]) #138
ny_mse[[2]][138] #s_prop = 0.0387

NY_sim <- Sim(beta=rep_len(ny_betas_est, length.out = 546), city=newyork, s_prop=0.0387, plot=TRUE)
