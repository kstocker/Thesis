...
##Optimize Beta Function to Find Beta: 

#mle(estimateBeta, start=list(beta=0, gamma=(1/2.2)), fixed=list(gamma=(1/2.2)), method ="Brent", lower=0, upper=6)

optim(fn=estimateBeta, par=c(beta=0), initial=initial, time=time, beta=0, gamma=(1/2.2), method="BFGS")

mle2(minuslogl = estimateBeta, start=list(beta=0), data=list(initial=initial, time=time, gamma=(0/2.2)))
```
